...
public class IKIExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(IKIDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new IKIStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static IKIDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static IKIDateTimeConverter dateTimeConverter = new IKIStandardDateTimeConverter();

    public IKIExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public IKIExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new IKIMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=IKIHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,IKIExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=IKIHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
