...
public class IKIKPSPublicSoap
{
    ...
    public IKIKPSPublicSoap(){}

    public IKIKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public IKIKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        IKIExtendedSoapSerializationEnvelope envelope= new IKIExtendedSoapSerializationEnvelope(IKIExtendedSoapSerializationEnvelope.VER11);
